...
export default defineConfig({
	...
	themeConfig: {
		...
		footer: {
			message:
				'Released under the <a href="https://github.com/typicalninja/disci/blob/main/LICENSE">Apache 2.0 License</a>.',
			copyright:
				'Copyright © 2023 <a href="https://typical.gq/">Typicalninja</a>',
		},
	},
	markdown: {
		theme: "github-dark",
