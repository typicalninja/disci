# Class: MessageCommandInteraction
...
- [constructor](MessageCommandInteraction.md#constructor)

### Properties

- [RawInteractionData](MessageCommandInteraction.md#rawinteractiondata)
- [appPermissions](MessageCommandInteraction.md#apppermissions)
- [applicationId](MessageCommandInteraction.md#applicationid)
- [channelId](MessageCommandInteraction.md#channelid)
- [commandId](MessageCommandInteraction.md#commandid)
- [commandName](MessageCommandInteraction.md#commandname)
- [commandType](MessageCommandInteraction.md#commandtype)
- [guildId](MessageCommandInteraction.md#guildid)
- [guildLocale](MessageCommandInteraction.md#guildlocale)
- [handler](MessageCommandInteraction.md#handler)
- [id](MessageCommandInteraction.md#id)
- [member](MessageCommandInteraction.md#member)
- [resolved](MessageCommandInteraction.md#resolved)
- [responded](MessageCommandInteraction.md#responded)
- [token](MessageCommandInteraction.md#token)
- [type](MessageCommandInteraction.md#type)
- [user](MessageCommandInteraction.md#user)
- [version](MessageCommandInteraction.md#version)

### Accessors

- [createdAt](MessageCommandInteraction.md#createdat)
- [createdTimestamp](MessageCommandInteraction.md#createdtimestamp)

### Methods

- [\_respond](MessageCommandInteraction.md#respond)
- [deferResponse](MessageCommandInteraction.md#deferresponse)
- [fetchReply](MessageCommandInteraction.md#fetchreply)
- [isAutoComplete](MessageCommandInteraction.md#isautocomplete)
- [isChatInputInteraction](MessageCommandInteraction.md#ischatinputinteraction)
- [isCommand](MessageCommandInteraction.md#iscommand)
- [isComponent](MessageCommandInteraction.md#iscomponent)
- [isMessageMenu](MessageCommandInteraction.md#ismessagemenu)
- [isSlashCommand](MessageCommandInteraction.md#isslashcommand)
- [isUserMenu](MessageCommandInteraction.md#isusermenu)
- [respond](MessageCommandInteraction.md#respond)
- [useCallback](MessageCommandInteraction.md#usecallback)
...
[packages/disci/src/structures/ApplicationCommand.ts:100](https://github.com/typicalninja493/disci/blob/96876f6/packages/disci/src/structures/ApplicationCommand.ts#L100)
...
[packages/disci/src/structures/ApplicationCommand.ts:99](https://github.com/typicalninja493/disci/blob/96876f6/packages/disci/src/structures/ApplicationCommand.ts#L99)
...
▸ `Private` **_respond**(`response`): [`MessageCommandInteraction`](MessageCommandInteraction.md)
...
▸ **respond**(`opts`): [`MessageCommandInteraction`](MessageCommandInteraction.md)
...
▸ `Private` **useCallback**(`fn`): [`MessageCommandInteraction`](MessageCommandInteraction.md)
