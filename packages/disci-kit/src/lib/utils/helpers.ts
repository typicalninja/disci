...
export function ignoreUndefined<T extends Record<string, unknown>>(
	array: (T | false)[],
): T[] {
...
export const logger = {
	info: (...messages: unknown[]) =>
		console.error(`[${pc.cyan("INFO")}]`, ...messages),
	warn: (...messages: unknown[]) =>
		console.error(`[${pc.yellow("WARN")}]`, ...messages),
	error: (...messages: unknown[]) =>
		console.error(`[${pc.red("ERROR")}]`, ...messages),
	details: (...messages: unknown[]) =>
		console.error(`[${pc.dim("↳")} Details]`, ...messages),
};
